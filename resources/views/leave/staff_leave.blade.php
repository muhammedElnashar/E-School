            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        data-export-options='{"fileName": "student-leave-request-list-<?= date('d-m-y') ?>","ignoreColumn": ["operate"]}' data-query-params="studentLeaveRequestQueryParams" data-escape="true">
