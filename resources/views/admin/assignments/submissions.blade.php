...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <h4 class="card-title">{{ __('Submissions List') }}</h4>
                    ...
                    <table class="table table-bordered table-striped text-center">
                        ...
                        @forelse ($submissions as $item)
                            <tr>
                                ...
                                <td>{{ $item->text }}</td>
                                <td><a href="{{ asset('files/'.$item->file_path) }}" target="_blank">Show File</a></td>
                                <td>{{ $item->grade }}</td>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('submission.destroy', $item->id) }}" method="POST"
                                          class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
